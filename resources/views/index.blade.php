...
>
    ...
    <div class="contact-content">
        ...
        <div style="margin-top:30px; display:flex; gap:15px; justify-content:center; flex-wrap:wrap;">
            <a href="#productos" style="display:inline-block; padding:12px 30px; border-radius:30px; border:2px solid violet; color:white; transition:0.3s; font-weight:500;">
                Ver productos
            </a>
            <a href="https://wa.me/5217222032942" target="_blank" style="display:inline-block; padding:12px 30px; border-radius:30px; background:violet; color:white; font-weight:500; transition:0.3s;">
                Contáctanos
            </a>
        </div>
    </div>
